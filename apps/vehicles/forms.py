...
class VehicleForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'value': forms.NumberInput(attrs={'class': 'w-full bg-slate-700/50 border border-slate-600 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-cyan-500'}),
